...
import single from '../img/images (1).png'
import double from '../img/images (2).png'
import triple from '../img/population-icon-people-icon-vector.jpg'
    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
            <img className='w-12 mx-auto mt-[-2rem]' img src={single} alt="/" />
          ...
          <div className='w-full bg-gray-100 shadow-xl flex flex-col p-4 md:my-0 my-4 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem] grayscale' img src={double} alt="/" />
            ...
            <button className='text-[#00df9a] bg-black w-[200px] rounded-md font-medium my-6 mx-auto  px-6 py-3 '>Get Started</button>
                 ...
                 {/* Third Card */}
          <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem]' img src={triple} alt="/" />
            <h2 className='text-2xl font-bold text-center py-8'>Single User</h2>
            <p className='text-center text-4xl font-bold'>$149</p>
            <div className='text-center font-medium '>
                <p className='py-2 border-b mx-8 mt-8'>500 GB Storage</p>
